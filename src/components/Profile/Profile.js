...
const Profile = ({user, onSubmit, toggleProfile}) => {
            ...
            <Row>
                ...
                <Col md={8}>
                    <div className='submit-container'>
                        <h6>Wins: {wins}</h6>
                        <div className='submit-container'>
                            <input className='submit-btn' type='image' src="https://img.icons8.com/emoji/48/000000/check-mark-emoji.png"/>
                            <img className='submit-btn' onClick={toggleProfile} src="https://img.icons8.com/material-outlined/24/fa314a/delete-sign.png"/>
                        </div>
                    </div>
                    <ToggleInput inputName='username' placeholder={username} />
                    {email && <ToggleInput inputName='email' placeholder={email} />}
                </Col>
            </Row>
        </Form>
    )
